...
control 'mdl version' do
  impact 1.0
  title 'confirm mdl version installed'
  desc 'confirm version reported by mdl matches the desired version'
  describe command('mdl --version') do
    its('stdout') { should include ('0.4.0') }
  end
end
